#ifndef SL_EMLIB_GPIO_INIT_EMUWAKEUP_CONFIG_H
#define SL_EMLIB_GPIO_INIT_EMUWAKEUP_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_EMUWAKEUP_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_EMUWAKEUP_MODE        gpioModeInputPullFilter

// <o SL_EMLIB_GPIO_INIT_EMUWAKEUP_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_EMUWAKEUP_DOUT        1
...
// <gpio> SL_EMLIB_GPIO_INIT_EMUWAKEUP
// $[GPIO_SL_EMLIB_GPIO_INIT_EMUWAKEUP]
#define SL_EMLIB_GPIO_INIT_EMUWAKEUP_PORT        gpioPortB
#define SL_EMLIB_GPIO_INIT_EMUWAKEUP_PIN         1
// [GPIO_SL_EMLIB_GPIO_INIT_EMUWAKEUP]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_EMUWAKEUP_CONFIG_H
