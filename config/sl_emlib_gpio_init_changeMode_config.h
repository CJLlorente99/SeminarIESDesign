#ifndef SL_EMLIB_GPIO_INIT_CHANGEMODE_CONFIG_H
#define SL_EMLIB_GPIO_INIT_CHANGEMODE_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_CHANGEMODE_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_CHANGEMODE_MODE        gpioModePushPull
...
#define SL_EMLIB_GPIO_INIT_CHANGEMODE_PORT       gpioPortA
#define SL_EMLIB_GPIO_INIT_CHANGEMODE_PIN        0
// [GPIO_SL_EMLIB_GPIO_INIT_CHANGEMODE]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_CHANGEMODE_CONFIG_H
