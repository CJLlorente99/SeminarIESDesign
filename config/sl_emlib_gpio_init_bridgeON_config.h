#ifndef SL_EMLIB_GPIO_INIT_BRIDGEON_CONFIG_H
#define SL_EMLIB_GPIO_INIT_BRIDGEON_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_BRIDGEON_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_BRIDGEON_MODE        gpioModePushPull

// <o SL_EMLIB_GPIO_INIT_BRIDGEON_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_BRIDGEON_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_BRIDGEON
// $[GPIO_SL_EMLIB_GPIO_INIT_BRIDGEON]
#define SL_EMLIB_GPIO_INIT_BRIDGEON_PORT         gpioPortA
#define SL_EMLIB_GPIO_INIT_BRIDGEON_PIN          0
// [GPIO_SL_EMLIB_GPIO_INIT_BRIDGEON]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_BRIDGEON_CONFIG_H
