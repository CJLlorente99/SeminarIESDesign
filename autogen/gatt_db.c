...
{
  0xdb, 0x6b, 0x38, 0x4c, 0x4e, 0xfc, 0x0c, 0x82, 0x2d, 0x45, 0xe0, 0x3f, 0x21, 0x37, 0xf1, 0x15, 
  0x92, 0xfa, 0x0e, 0x39, 0xd0, 0x58, 0xa8, 0x9f, 0xdd, 0x4a, 0x11, 0x3e, 0xde, 0x44, 0x19, 0x58, 
  0xad, 0x95, 0x85, 0xa8, 0xdc, 0x6a, 0xb9, 0xb0, 0xce, 0x44, 0x1b, 0xef, 0xbc, 0xe4, 0xf1, 0x57, 
  0x49, 0x96, 0x63, 0x5c, 0xd0, 0x67, 0x16, 0x97, 0xf8, 0x4a, 0x05, 0x2a, 0x32, 0x7c, 0xb2, 0x0a, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_34) = {
  .len = 11,
  .data = { 0x74, 0x65, 0x6d, 0x70, 0x65, 0x72, 0x61, 0x74, 0x75, 0x72, 0x65, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_30) = {
  .len = 8,
  .data = { 0x73, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x5f, 0x33, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_26) = {
  .len = 8,
  .data = { 0x73, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x5f, 0x32, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_22) = {
  .len = 8,
  .data = { 0x73, 0x74, 0x72, 0x61, 0x69, 0x6e, 0x5f, 0x31, }
};
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_18) = {
  .len = 16,
  .data = { 0xe1, 0xf1, 0x87, 0xf9, 0x4c, 0x72, 0xec, 0x83, 0xeb, 0x41, 0x6c, 0x60, 0xdb, 0x77, 0x9b, 0x31, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  .properties = 0x0a,
  .max_len = 14,
  .data = { 0x4d, 0x32, 0x30, 0x20, 0x4d, 0x61, 0x73, 0x74, 0x65, 0x72, 0x20, 0x4d, 0x43, 0x55, },
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x18, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x12, .char_uuid = 0x8001 } },
  { .handle = 0x19, .uuid = 0x8001, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_24 },
  ...
  { .handle = 0x1c, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x12, .char_uuid = 0x8002 } },
  { .handle = 0x1d, .uuid = 0x8002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_28 },
  ...
  { .handle = 0x20, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x12, .char_uuid = 0x8003 } },
  { .handle = 0x21, .uuid = 0x8003, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x01, .dynamicdata = &gattdb_attribute_field_32 },
  { .handle = 0x22, .uuid = 0x000b, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x03, .configdata = { .flags = 0x01, .clientconfig_index = 0x04 } },
  ...
  { .handle = 0x25, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8004 } },
  { .handle = 0x26, .uuid = 0x8004, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
